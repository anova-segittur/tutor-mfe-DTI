...
CORE_MFE_APPS: dict[str, MFE_ATTRS_TYPE] = {
    ...
    "learning": {
        "repository": "https://github.com/anova-segittur/frontend-app-learning-DTI",
        "refs": "https://api.github.com/repos/anova-segittur/frontend-app-learning-DTI/git/refs/" + gh_refs_path(),
        "port": 2000,
    },
    "ora-grading": {
